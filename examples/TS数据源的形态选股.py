...
from czsc.connectors.ts_connector import get_raw_bars, get_symbols, tdc

ts.set_token('ed79452f9346a39392a41dcacea4e0f0d5b0b41d21d26150153e93de')
pro = ts.pro_api()
...
def get_events_matched(refresh=False):
    ...
    ems_params = {
        ...
        "edt": "2024-11-07",
        "max_workers": 10,
        "results_path": r"/root/量化投研/EMS测试A",
    }
...
if __name__ == '__main__':
    ...
    # 过滤掉ST股票
    dfb = tdc.daily_basic_new(max_dt)[['ts_code', 'name', 'industry', 'area']]
